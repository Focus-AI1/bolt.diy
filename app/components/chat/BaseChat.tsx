        ...
        <div ref={scrollRef} className="flex flex-col lg:flex-row w-full h-full overflow-hidden">
          <div className={classNames(styles.Chat, 'flex flex-col flex-grow lg:min-w-[var(--chat-min-width)] h-full')}>
            ...
            {!chatStarted && chatMode === 'chat' && (
              <div id="intro" className="mt-[1vh] mb-4 max-w-chat mx-auto text-center px-4 lg:px-0 flex-shrink-0">
                <h1 className="text-3xl lg:text-5xl font-bold text-bolt-elements-textPrimary mb-2 animate-fade-in">
                  Where prompts become:
                  <RotatingText />
                </h1>
                <p className="text-md lg:text-lg mb-2 text-bolt-elements-textSecondary animate-fade-in animation-delay-200"> 
            ...
            {chatMode === 'chat' ? (
              <div className={classNames(styles.chatContent, "flex-1 flex flex-col")}>
                <StickToBottom
                  className="flex-1 pt-1 flex flex-col"
                  resize="smooth"
                  initial="smooth"
                >
            ...
            {chatMode === 'chat' && !chatStarted && (
              <div id="examples" className="flex flex-col justify-center gap-2 mt-2 pb-2 flex-shrink-0 px-2 sm:px-4">
